...
public class CityFactory {
  ...
  private static final Map<BuildingType,Integer> STARTER = Map.of(
      ...
      BuildingType.MINE,1, BuildingType.EXTRACTOR,1, BuildingType.FARM,2, BuildingType.WAREHOUSE,1);
  ...
  public City createPlayerCity(Long worldId, Long playerId, Long islandId, int slot, String name,
    ...
    c.setWood(500); c.setStone(500); c.setWheat(250);
    if (race != null) c.set(race.specialResource, 100);
    c = cities.save(c);
